    ...
    <section class="bg-white dark:bg-gray-900 rounded-lg">
        <div class="p-12 mx-auto max-w-screen-xl">
            <div class="max-w-screen-md">
                ...
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">MUA Pesta</h2>
                <p class="mb-8 font-light text-gray-500 sm:text-xl dark:text-gray-400">There are many variations of
